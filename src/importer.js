...
var dependencyScripts = [
    ...
    './src/character/state/character-state.js',
    './src/character/state/character-moving-state.js',
    './src/character/state/character-idle-state.js',
    './src/character/state/character-harmed-state.js',
    './src/character/state/character-state-context.js',
